          ...
          <div className="space-y-16">
            ...
            <section className="text-center">
              ...
              >
                ...
                <p className="text-xs mt-6 pt-4 border-t border-gray-700" style={{ color: 'var(--text-secondary)', lineHeight: '1.4' }}>
                  <span style={{ color: 'var(--text-primary)', fontWeight: 600 }}>Focus = </span>How much capacity you have today for deep, uninterrupted work — based on meeting load, available focus blocks, and schedule flow.
                </p>
              </div>
            </section>
          </div>
          ...
          <div className="space-y-16">
            ...
            <section className="text-center">
              ...
              >
                ...
                <p className="text-xs mt-6 pt-4 border-t border-gray-700" style={{ color: 'var(--text-secondary)', lineHeight: '1.4' }}>
                  <span style={{ color: 'var(--text-primary)', fontWeight: 600 }}>Strain = </span>How much cognitive load your schedule is putting on you today — context switches, back-to-back meetings, and decision fatigue.
                </p>
              </div>
            </section>
          </div>
          ...
          <div className="space-y-16">
            ...
            <section className="text-center">
              ...
              >
                ...
                <p className="text-xs mt-6 pt-4 border-t border-gray-700" style={{ color: 'var(--text-secondary)', lineHeight: '1.4' }}>
                  <span style={{ color: 'var(--text-primary)', fontWeight: 600 }}>Balance = </span>Can you keep this pace up? Measures whether your schedule has enough recovery time and healthy boundaries to avoid burnout.
                </p>
              </div>
            </section>
