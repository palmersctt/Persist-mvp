...
export default function WorkHealthDashboard() {
      ...
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: 'var(--cream)' }}>
        <div className="text-center flex flex-col items-center">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-2xl font-semibold text-[#1C1917]" style={{ letterSpacing: '1.5px' }}>Persistwork</span>
          </div>
  ...
  if (!session) {
    if (showOnboarding) {
      return (
        <div className="min-h-screen text-[#1C1917] flex items-center justify-center px-4">
          <div className="max-w-md w-full">
            ...
            <div className="bg-[#FEFCF9] rounded-2xl p-8 border border-[#E7E0D8]">
              ...
              <div className="space-y-5 mb-8">
                <div className="flex items-start space-x-4">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(90,122,92,0.15)' }}>
                    <span className="text-sm font-bold" style={{ color: '#5A7A5C' }}>F</span>
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(192,84,74,0.15)' }}>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(232,125,58,0.15)' }}>
                    <span className="text-sm font-bold" style={{ color: '#E87D3A' }}>B</span>
                  </div>
                  <div>
              ...
              <button
                ...
                className="w-full bg-[#E87D3A] text-white py-4 px-6 rounded-xl font-semibold hover:bg-[#d06a2e] transition-colors"
              >
                Get Started
              </button>
            </div>
        ...
        <div className="max-w-md w-full text-center">
          ...
          <div className="bg-[#FEFCF9] rounded-2xl p-8 border border-[#E7E0D8]">
            ...
            <button
              ...
              className="w-full bg-[#E87D3A] text-white py-3 px-6 rounded-xl font-semibold hover:bg-[#d06a2e] transition-colors flex items-center justify-center space-x-2"
            >
  ...
  if (error && !workHealth) {
    return (
      <div className="min-h-screen" style={{ backgroundColor: 'var(--background)' }}>
        <header className="px-6 py-6 sticky top-0 z-40 bg-[#FEFCF9]/90 backdrop-blur-sm border-b border-[#E7E0D8]">
          <div className="max-w-5xl mx-auto flex justify-between items-center">
            <div className="flex items-center gap-2">
              <PersistLogo size={24} variant="dark" />
              <span className="text-lg font-semibold" style={{ color: 'var(--ink)', letterSpacing: '1.5px' }}>Persistwork</span>
            </div>
            <button
              onClick={() => signOut()}
              className="text-xs font-medium px-3 py-1.5 rounded-md transition-all duration-200 hover:scale-105 hover:shadow-lg"
              onMouseEnter={(e) => {
                e.currentTarget.style.backgroundColor = 'rgba(28,25,23,0.08)';
        ...
        <div className="max-w-5xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor = 'transparent';
                e.currentTarget.style.borderColor = isLoading ? 'rgba(28,25,23,0.04)' : 'rgba(28,25,23,0.08)';
              }}
              style={{ 
                color: isLoading ? 'var(--ink-faint)' : 'var(--ink-light)',
                border: `1px solid ${isLoading ? 'rgba(28,25,23,0.04)' : 'rgba(28,25,23,0.08)'}`,
                backgroundColor: 'transparent',
            ...
            <div ref={profileRef} className="relative">
              <button
                ...
                style={{ borderColor: showProfile ? 'rgba(28,25,23,0.3)' : 'rgba(28,25,23,0.1)' }}
              >
                {session?.user?.image ? (
                  <img src={session.user.image} alt="" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                ) : (
                  <div className="w-full h-full flex items-center justify-center text-xs font-bold" style={{ backgroundColor: 'rgba(28,25,23,0.08)', color: 'var(--ink-light)' }}>
              ...
              {showProfile && (
                <div
                  ...
                  style={{ backgroundColor: '#FEFCF9', border: '1px solid rgba(28,25,23,0.08)' }}
                >
                  <div className="p-4 border-b" style={{ borderColor: 'rgba(28,25,23,0.06)' }}>
                    <div className="flex items-center gap-3">
                      {session?.user?.image && (
                        <img src={session.user.image} alt="" className="w-10 h-10 rounded-full" referrerPolicy="no-referrer" />
                      )}
                      <div className="min-w-0">
                        <p className="text-sm font-medium truncate" style={{ color: 'var(--ink)' }}>{session?.user?.name}</p>
                        <p className="text-xs truncate" style={{ color: 'var(--ink-faint)' }}>{session?.user?.email}</p>
                      </div>
                    </div>
                  </div>
                  <div className="p-4 border-b" style={{ borderColor: 'rgba(28,25,23,0.06)' }}>
                    <p className="text-[10px] uppercase tracking-wider font-semibold mb-2" style={{ color: 'var(--ink-faint)' }}>Permissions</p>
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-2">
                        <span className="text-[#5A7A5C] text-xs">&#10003;</span>
                        <span className="text-xs" style={{ color: 'var(--ink-light)' }}>Email address</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-[#5A7A5C] text-xs">&#10003;</span>
                        <span className="text-xs" style={{ color: 'var(--ink-light)' }}>Profile info (name, photo)</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-[#5A7A5C] text-xs">&#10003;</span>
                        <span className="text-xs" style={{ color: 'var(--ink-light)' }}>Google Calendar (read-only)</span>
                      </div>
                    </div>
                  </div>
                  <div className="p-3">
                    <button
                      ...
                      style={{ color: 'var(--ink-light)', backgroundColor: 'rgba(28,25,23,0.04)' }}
      ...
      <div className="max-w-5xl mx-auto px-6 pb-12 space-y-16">
                  ...
                  <button
                    ...
                    className={`w-full py-4 px-6 rounded-xl text-sm font-medium transition-all duration-200 ${
                      shareState === 'generating'
                        ? 'bg-[rgba(28,25,23,0.03)] border border-[rgba(28,25,23,0.06)] text-[var(--ink-faint)] cursor-wait'
                        : 'bg-[rgba(28,25,23,0.03)] border border-[rgba(28,25,23,0.06)] text-[var(--ink-light)] hover:bg-[rgba(28,25,23,0.08)] hover:border-[rgba(28,25,23,0.15)] cursor-pointer'
                    }`}
                  >
              ...
              <section className="max-w-xs mx-auto">
                <style>{`
                  ...
                  .skeleton-bar::after {
                    ...
                    position: absolute;
                    inset: 0;
                    background: linear-gradient(90deg, transparent 0%, rgba(28,25,23,0.06) 50%, transparent 100%);
                ...
                <div
                  ...
                  style={{
                    background: 'linear-gradient(to bottom, #E7E0D8, #FBF7F2)',
                    padding: '32px 24px 20px',
                  }}
                >
                  {/* Quote skeleton */}
                  <div className="skeleton-bar h-6 rounded-lg mx-auto mb-2" style={{ backgroundColor: 'rgba(28,25,23,0.08)', maxWidth: '85%' }} />
                  <div className="skeleton-bar h-6 rounded-lg mx-auto mb-4" style={{ backgroundColor: 'rgba(28,25,23,0.05)', maxWidth: '60%' }} />
                  ...
                  {/* Score bar skeleton */}
                  <div className="rounded-2xl px-5 py-4" style={{ backgroundColor: 'rgba(28,25,23,0.06)' }}>
                    <div className="skeleton-bar h-2 rounded mx-auto mb-3" style={{ backgroundColor: 'rgba(28,25,23,0.04)', maxWidth: '30%' }} />
                    <div className="flex justify-center gap-8">
                      {['FOCUS', 'STRAIN', 'BALANCE'].map((label) => (
                        <div key={label} className="text-center">
                          <div className="text-xl font-bold" style={{ color: 'rgba(28,25,23,0.1)', lineHeight: 1 }}>--</div>
                          <div className="text-[9px] uppercase tracking-wider mt-1.5 font-medium" style={{ color: 'rgba(28,25,23,0.1)' }}>{label}</div>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-center gap-1.5 mt-3">
                    ...
                    <span className="text-[9px] tracking-widest" style={{ color: 'rgba(28,25,23,0.1)' }}>Persistwork.com</span>
                  </div>
                </div>
        ...
        {activeTab === 'performance' && (
          <div className="space-y-16">
            <button onClick={() => setActiveTab('overview')} className="flex items-center space-x-2 text-sm transition-opacity hover:opacity-70" style={{ color: 'var(--ink-faint)' }}>
              <span>&larr;</span><span>Back to Overview</span>
            </button>
            {/* Large Focus Ring */}
            <section className="text-center">
              <div className="relative w-32 h-32 mx-auto mb-8">
                <svg className="w-full h-full persist-progress-ring" viewBox="0 0 120 120">
                  <circle 
                    cx="60" cy="60" r="54" 
                    fill="none" 
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <div className="text-center">
                    ...
                    <div className="text-center">
                      <div className="persist-metric-label" style={{ fontSize: '0.75rem', lineHeight: '1' }}>
                        FOCUS
                      </div>
                    </div>
                  </div>
                  ...
                  {isAILoading && activeTab === 'performance' ? (
                    <div className="flex items-center justify-center py-4">
                      <div className="flex items-center space-x-2">
                        <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-[#E87D3A]"></div>
                    ...
                    if (!insight) return <p className="text-xs text-center" style={{ color: 'var(--ink-faint)' }}>No insights available</p>;
                    return (
                      <div className="text-center">
                        ...
                        {insight.action && (
                          <p className="text-xs mt-2 leading-relaxed" style={{ color: '#5A7A5C', opacity: 0.85 }}>
                            {insight.action}
                          </p>
                        )}
                      </div>
                ...
                <div className="space-y-5 mb-6">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-xs" style={{ color: 'var(--ink-faint)', fontWeight: '500' }}>
                  ...
                  {isAILoading && activeTab === 'resilience' ? (
                    ...
                    return (
                      <div className="text-center">
                        ...
                        {insight.action && (
                          <p className="text-xs mt-2 leading-relaxed" style={{ color: '#C0544A', opacity: 0.85 }}>
                            {insight.action}
                          </p>
                        )}
                      </div>
