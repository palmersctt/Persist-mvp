...
const DARK_TOKENS = {
  ...
  ghostNum: 'rgba(255,255,255,0.22)',
  ghostLbl: 'rgba(255,255,255,0.18)',
  flatNum: 'rgba(255,255,255,0.65)',
  flatLbl: 'rgba(255,255,255,0.4)',
...
const LIGHT_TOKENS = {
  popNum: 'rgba(232,125,58,0.9)',
  popLbl: 'rgba(232,125,58,0.55)',
  ghostNum: 'rgba(28,25,23,0.28)',
  ghostLbl: 'rgba(28,25,23,0.22)',
  ...
  source: 'rgba(28,25,23,0.5)',
  subtitle: 'rgba(28,25,23,0.42)',
